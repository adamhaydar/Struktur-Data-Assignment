...
```
Pada program guided 2 ini, pengelolaan antrian dilakukan menggunakan queue berbasis array dengan menerapkan prinsip FIFO (First In First Out). Program ini memiliki fungsi yang serupa dengan program sebelumnya, namun dilengkapi tiga jenis implementasi, yaitu implementasi 1 (head tetap, tail bergerak), implementasi 2 (head dan tail bergerak), serta implementasi 3 (head dan tail berputar).
