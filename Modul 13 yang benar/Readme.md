...
Multi linked list adalah struktur data di mana satu node bisa punya lebih dari satu pointer, sehingga bisa membentuk hubungan yang lebih kompleks seperti induk–anak atau grid. Struktur ini memudahkan proses tambah dan hapus data karena pointer-nya fleksibel, dengan operasi insert dan delete pada node induk maupun anak dilakukan dengan mengatur ulang pointer agar struktur tetap rapi.
...
```
Program ini untuk mengelola menu restoran, di mana parent berperan sebagai kategori makanan dan child sebagai daftar menu di dalam kategori tersebut. Program ini dapat melakukan penambahan data, pencarian, pembaruan, penghapusan, serta menampilkan seluruh struktur data dengan rapi. Dari praktikum ini, dapat dipahami bahwa MLL sangat berguna untuk menyimpan data yang saling berhubungan secara bertingkat dan memudahkan pengelolaan data yang kompleks secara terstruktur
...
```
#### Output:
<img width="368" height="759" alt="image" src="https://github.com/user-attachments/assets/ec7d3bcc-ce8f-48de-b660-f4d6c20b8898" />


Program ini dipakai untuk menyimpan dan mengatur data mahasiswa dalam bentuk daftar yang saling terhubung. Data bisa ditambahkan di awal, di akhir, atau di tengah sesuai kebutuhan, lalu ditampilkan satu per satu. Dari program ini, kita bisa melihat bagaimana data mahasiswa disusun rapi dan mudah diatur tanpa harus pakai array.

#### Full code Screenshot:
<img width="499" height="901" alt="image" src="https://github.com/user-attachments/assets/bd0209df-5bd2-4b55-9b15-eb0267747ef7" />
<img width="463" height="836" alt="image" src="https://github.com/user-attachments/assets/b823b9a6-03a4-4cfe-b5eb-5f23f24b4cea" />
<img width="660" height="873" alt="image" src="https://github.com/user-attachments/assets/74c47031-fa14-48a6-93b1-a8a4463c8584" />



## Kesimpulan
Pada materi ini, kita mempelajari dua jenis linked list lanjutan, yaitu multilist dan circular doubly linked list. Multilist membahas cara membentuk hubungan induk–anak serta mengelola proses tambah dan hapus data, sedangkan circular doubly linked list menjelaskan list yang berbentuk melingkar dan bisa ditelusuri dari dua arah. Keduanya menekankan pentingnya pengaturan pointer agar struktur data tetap rapi dan konsisten.

## Referensi
[1] Hardiyana, B., Fadilah, L., & Effendi, D. (2020, July). Application of linked list algorithm based on multimedia. In IOP Conference Series: Materials Science and Engineering (Vol. 879, No. 1, p. 012087). IOP Publishing.
[2] Ai
[3] teman
